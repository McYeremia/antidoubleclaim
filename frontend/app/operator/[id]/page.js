  ...
  return (
    <div className="min-w-0 overflow-hidden">
      ...
      <a href={url} target="_blank" rel="noopener noreferrer"
         className="text-[13px] font-bold text-[#046137] hover:text-[#035230] mt-1 flex items-center gap-1.5 transition-colors overflow-hidden">
        <span className="truncate underline underline-offset-4">{displayName}</span>
          ...
          <div className="bg-orange-50/50 border border-orange-200 rounded-[32px] p-10 animate-pulse-slow shadow-xl shadow-orange-100/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                ...
                <CertPreview
                  url={`${API_URL}/uploads/${miripClaim.sertifikat_filename}`}

      ...
      <div className={`px-6 py-4 border-b flex items-center justify-between border-gray-50 ${color}`}>
        ...
        <div className="flex items-center gap-2">
          ...
          {onExport && items.length > 0 && (
            <button
              onClick={onExport}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-black bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors"
            >

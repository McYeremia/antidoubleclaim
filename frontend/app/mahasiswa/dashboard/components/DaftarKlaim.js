      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto"
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b sticky top-0 bg-white z-10">
          <div className="flex items-center gap-3 min-w-0">
            <h3 className="text-base font-bold text-gray-900 truncate">{claim.nama_lomba}</h3>
            <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold whitespace-nowrap flex-shrink-0 ${STATUS_STYLE(claim.status)}`}>
        ...
        <div className="p-6 space-y-1">
          ...
          {claim.periode_nama && (
            <div className="flex items-center gap-2 py-2 px-3 bg-[#f0f7f3] border border-[#d4ebe0] rounded-xl mb-2">
              <svg className="w-3.5 h-3.5 text-[#046137] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <p className="text-xs font-semibold text-[#046137]">{claim.periode_nama}</p>
            </div>
          )}

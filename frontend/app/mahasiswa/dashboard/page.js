...
// ── Komponen Bar Chart (CSS, no library) ──────────────────────────────────────
function BarChart({ data, colorClass = "bg-blue-500", formatLabel }) {
...
function VisualisasiData() {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/stats/visualisasi")
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <BarChart
              data={stats.by_fakultas}
              colorClass="bg-blue-500"
              formatLabel={shortenFakultas}
            />
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            {/* Donut-style summary untuk 2 kategori */}
